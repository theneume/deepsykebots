...
def init_profile():
    ...
    try:
        ...
        greetings = {
            "SS": f"Welcome, {name}. What would you like to build in your photography journey?",
            "SD": f"Welcome, {name}! I'm here to guide and support you. How can I help you today?",
            "DS": f"Welcome, {name}! Ready to discover new directions? What interests you most?",
            "DD": f"Welcome, {name}! Let's get started. What are you looking to achieve?"
        }
